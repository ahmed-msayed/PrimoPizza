...
struct OrderDetailUpdateView: View {
...
struct OrderDetailUpdateView_Previews: PreviewProvider {
    static var previews: some View {
        OrderDetailUpdateView(orderItem:  .constant(testOrderItem), presentSheet: .constant(true), newOrder: .constant(false)).environmentObject(OrderModel())
    }
}
